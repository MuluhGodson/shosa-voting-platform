                ...
                <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="1000" class="shadow-lg transition hover:px-1 duration-500 ease-in-out  col rounded hover:border-r-2 hover:boder-r-white hover:border-l-2 hover:border-l-secondary cursor-pointer hover:transform hover:scale-150">
                    <div wire:click="openView('{{ $contest->slug }}')">
                        ...
                        <div class="p-2 my-1">
                            ...
                            <p class="text-gray-400 text-center">{{ Str::words(strip_tags($contest->description),15,'...') }}</p>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-center content-end p-3">
                            <div>
                                <a href="{{ route('candidate.apply', $contest->slug) }}" class="rounded-full px-2 py-1 bg-transparent border border-secondary text-secondary font-semibold hover:bg-secondary hover:text-gray-400">Apply Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-black bg-opacity-75 mx-6 lg:mx-0">
                    ...
                    <div class="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <div class="pt-12 pb-8">
                            <a href="{{ route('vote.candidate', $slug) }}" class="rounded-full px-2 py-1 bg-transparent border border-secondary text-secondary font-semibold hover:bg-secondary hover:text-gray-400">
                                View Contestants
                            </a>
                ...
                <div class="absolute top-0 right-0 h-12 w-18 p-4">
                    <div class="flex gap-4">
                        <div class="pt-12 pb-8 mx-1">
                            <a href="{{ route('vote.candidate', $slug) }}" class="bg-transparent border border-secondarytext-secondary hover:text-white hover:bg-secondary font-bold py-2 px-4 rounded">
                            Vote Now
                            </a> 
                        </div>
                        <div class="pt-12 pb-8 mx-1">
                            <a href="{{ route('candidate.apply', $slug) }}" class="bg-secondary hover:bg-transparent hover:border hover:border-secondary hover:text-secondary text-white font-bold py-2 px-4 rounded">
                            Register Now
                            </a> 
                        </div>
                    </div>
