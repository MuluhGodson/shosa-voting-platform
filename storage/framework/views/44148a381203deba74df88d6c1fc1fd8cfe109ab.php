<div>
    ...
    <?php endif; ?>
        <div class="my-8">
            <h1 class="text-center text-xl md:text-4xl text-gray-300"> Select a contest to participate in</span> </h1>
        </div>
                    ...
                    <div wire:click="openView('<?php echo e($contest->slug); ?>')">
                        ...
                        <div class="my-1 flex justify-end py-1 px-1">
                            <?php if(($contest->active) && ($contest->ending_date >= today()->toDateString())): ?>
                                <small class="my-2 text-right px-2 rounded-full bg-secondary text-white">applications open</small>
                            <?php else: ?>
                                <small class="my-2 text-right px-2 rounded-full bg-red-600 text-white">applications closed</small>
                            <?php endif; ?>
                        </div>
                        <div class="p-2 my-1">
                            ...
                            <p class="text-gray-400 text-center"><?php echo e(Str::words(strip_tags($contest->description),15,'...')); ?></p>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-center content-end p-3">
                            <div>
                                <a href="<?php echo e(route('candidate.apply', $contest->slug)); ?>" class="rounded-full px-2 py-1 bg-transparent border border-secondary text-secondary font-semibold hover:bg-secondary hover:text-gray-400">Apply Now</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="max-w-4xl flex items-center h-auto flex-wrap mx-auto my-32 lg:my-0">
                ...
                <div class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-black bg-opacity-75 mx-6 lg:mx-0">
                    ...
                    <div class="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <h1 class="text-xl font-bold pt-8 lg:pt-0 text-secondary text-justify uppercase"><?php echo e($name); ?></h1>
                        ...
                        <div>
                            <p class="text-base uppercase font-bold flex items-center justify-center lg:justify-start">
                                <?php if($fee): ?>
                                    <small>PARTICIPATION: <?php echo e($amount); ?></small>
                                <?php else: ?>
                            ...
                            <p class="text-base uppercase font-bold flex items-center justify-center lg:justify-start">
                                <?php if($tarrif): ?>
                                    <small class="my-2">VOTING: <?php echo e($vote_fee); ?></small>
                                <?php else: ?>
                        ...
                        <p class="pt-8 text-sm text-justify">
                            <?php echo e(Str::words(strip_tags($description),$text_words,'...')); ?>
                        ...
                        <div class="pt-12 pb-8">
                            <a href="<?php echo e(route('vote.candidate', $slug)); ?>" class="rounded-full px-2 py-1 bg-transparent border border-secondary text-secondary font-semibold hover:bg-secondary hover:text-gray-400">
                                View Contestants
                            </a>
                ...
                <div class="absolute top-0 right-0 h-12 w-18 p-4">
                    <div class="flex gap-4">
                        <div class="pt-12 pb-8 mx-1">
                            <a href="<?php echo e(route('vote.candidate', $slug)); ?>" class="bg-transparent border border-secondarytext-secondary hover:text-white hover:bg-secondary font-bold py-2 px-4 rounded">
                            Vote Now
                            </a> 
                        </div>
                        <div class="pt-12 pb-8 mx-1">
                            <a href="<?php echo e(route('candidate.apply', $slug)); ?>" class="bg-secondary hover:bg-transparent hover:border hover:border-secondary hover:text-secondary text-white font-bold py-2 px-4 rounded">
                            Register Now
                            </a> 
                        </div>
                    </div>
...
<?php /**PATH /var/www/shosa/resources/views/livewire/application-component.blade.php ENDPATH**/ ?>