<nav x-data="{ open: false }" class="bg-black border-b border-secondary">
...
<?php $component->withAttributes(['align' => 'right','width' => '60']); ?>
                             <?php $__env->slot('trigger', null, []); ?> 
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-secondary text-sm leading-4 font-medium rounded-md text-gray-500 bg-transparent hover:bg-gray-50 hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition">
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                         <?php $__env->slot('trigger', null, []); ?> 
                            ...
                            <?php else: ?>
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-400 bg-transparent hover:text-secondary focus:outline-none transition">
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                <div>
                    <div class="font-medium text-base text-secondary"><?php echo e(Auth::user()->name); ?></div>
...
<?php /**PATH /var/www/shosa/resources/views/navigation-menu.blade.php ENDPATH**/ ?>