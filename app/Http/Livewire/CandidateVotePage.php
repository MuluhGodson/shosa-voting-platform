...
class CandidateVotePage extends Component
{
    ...
    public $data, $refs, $slug, $p_type, $free_vote, $fee, $momo_tel, $name, $tel, $email, $vote_number;
    public $currencies, $vote_fee, $currency, $vote_count, $vote_amount, $currency_symbol, $vp;



    public function mount($contest, $candidate)
    {   
        $this->contest = $contest;
        $this->candidate = $candidate;
        $this->vote_number = $candidate->votes()->sum('vote_count');
    ...
    {
        return view('livewire.candidate-vote-page');
    }
